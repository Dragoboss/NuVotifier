...
public class Queries {
	private final boolean debug = NuVotifierBukkit.getInstance().getConfig().getBoolean("debug");
	private Connection connection = null;
	
        private final String succesfulSQL = "CREATE TABLE IF NOT EXISTS votesreceived ( id INT (6) NOT NULL AUTO_INCREMENT, date TIMESTAMP, protocol VARCHAR (4), address VARCHAR (100) NOT NULL, service VARCHAR (80) NOT NULL, voter VARCHAR (50) NOT NULL, PRIMARY KEY (id));";
        private final String failedSQL = "CREATE TABLE IF NOT EXISTS votesfailed ( id INT (6) NOT NULL AUTO_INCREMENT, date TIMESTAMP, protocol VARCHAR (4), address VARCHAR (100) NOT NULL, service VARCHAR (80) NOT NULL, voter VARCHAR (50) NOT NULL, PRIMARY KEY (id));";
